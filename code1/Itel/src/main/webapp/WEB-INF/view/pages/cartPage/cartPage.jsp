            ...
            <c:choose>
                <c:when test="${empty cartItems}">
                    <div class="alert alert-info text-center">
                        Your cart is empty. <a href="<%= ProjectPaths.HREF_TO_HOMEPAGE %>" class="alert-link">Continue shopping</a>.
                    </div>
                </c:when>
                <c:otherwise>
                    <div id="cartItems">
                    ...
                    <div class="total-section">
                        ...
                        <div class="text-end">
                            <form id="createOrderForm" action="/Itel/cart/createOrder" method="post">
            ...
            fetch('/Itel/cart/createOrder', {
              ...
              .then(data => {
                  if (data.success) {
                      ...
                      window.location.href = `/Itel/payment/momo?orderId=${data.orderId}&amount=${total}`;
                  } else {
                      alert(data.message);
                  }
              });
